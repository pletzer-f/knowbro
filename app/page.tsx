...
// Home: the companies dashboard — where day-to-day use starts.
// Researching a new company lives at /analyse (guided flow).
...
export default function HomePage() {
  ...
  return (
    <main>
      ...
      <p>
        <Link href="/analyse">
          <button type="button">+ Research a new company</button>
        </Link>
      </p>
      {error && (
        <p>
      ...
      {rows === null ? (
        ...
        <p>
          Nothing here yet — research your first company and save the dossier; it appears here with its financial
          model.
        </p>
      ) : (
